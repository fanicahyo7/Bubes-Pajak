...
Public Class frmResetJurnal
    ...
    Public Sub New(ConnStr As String, tanggal As Date, kodecompany As String)
        InitializeComponent()
        pConnStr = ConnStr
        Me.tanggal = tanggal
    ...
    Sub loaddata()
        Dim query As String = _
            "select cast(0 as bit) as Ambil," & _
                "NoBukti,TanggalBukti,KodeAkun,NamaAkunPajak," & _
                "case when DebetOrKredit='D' then Jumlah else 0 end as Debet," & _
                "case when DebetOrKredit='K' then Jumlah else 0 end as Kredit," & _
                "KodeAkunLama," & _
    ...
    Private Sub btnReset_Click(sender As Object, e As EventArgs) Handles btnReset.Click
        ...
        Else
            ...
            'exec laba rugi
            cmd = New SqlCommand("exec sp_UpdGL '" & kodecompany & "'", kon)
            cmd.CommandTimeout = 0
            cmd.ExecuteNonQuery()

            'exec neraca
            cmd = New SqlCommand("exec sp_UpdNS '" & kodecompany & "'", kon)
            cmd.CommandTimeout = 0
            cmd.ExecuteNonQuery()
